...
namespace MineOS.Infrastructure.Migrations
{
    ...
    [Migration("20260829133657_AddCrashDiagnoses")]
    partial class AddCrashDiagnoses
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MineOS.Domain.Entities.CrashDiagnosis", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<string>("RedactedInput")
                        .IsRequired()
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("ServerName", "CrashEventId");

                    b.HasIndex("ServerName", "SourceHash")
                        .IsUnique();

                    b.ToTable("CrashDiagnoses");
                });
